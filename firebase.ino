...
#define ECHO_PIN 14
#define DISTANCE_THRESHOLD 10 // Set the distance threshold in centimeters
...
#define FILE_PHOTO_PATH "/photo" + String(i) + ".jpg"
#define BUCKET_PHOTO "/data/photo " + String(i)+ ".jpg"
...
void capturePhotoSaveLittleFS( int i ) {
...
void setup() {
 ...
 //difining connectio with ultrasonic sensor
